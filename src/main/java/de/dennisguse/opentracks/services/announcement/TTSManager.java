...
public class TTSManager extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnGenerateSpeech = findViewById(R.id.track_recording_fab_action);

        btnGenerateSpeech.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Assuming VoiceAnnouncementManager.createAnnouncement() requires some data
                // Replace 'someData' with the actual data you want to use for the announcement
                Track track = new Track(); // Assuming Track has appropriate constructor
                String announcement = VoiceAnnouncementManager.createAnnouncement(track, someData);

                // Log the announcement
                Log.d(TAG, "Generated announcement: " + announcement);

                // Update the UI with the announcement
                updateUIWithAnnouncement(announcement);

                // Speak the generated announcement
                tts.speak(announcement, TextToSpeech.QUEUE_FLUSH, null, "not used");
            }
        });
    }

    private void updateUIWithAnnouncement(String announcement) {
        // Example: Update a TextView with the announcement
        TextView textView = findViewById(R.id.textViewAnnouncement);
