...
public class TTSManager extends AppCompatActivity {
    ...
    private final UtteranceProgressListener utteranceListener = new UtteranceProgressListener() {
        ...
        public void onStart(String utteranceId) {
            ...
            run = findViewById(R.id.track_recording_fab_action);//when utterance begins
...
//    }
    ...
    // Existing TTSManager class modifications

    // Ensures that TextToSpeech is set up and ready to be used, sets up button click to use TTS
    void onTtsReady(Button run) {
        ...
        if (run != null) {
            ...
            tts = new TextToSpeech(getApplicationContext(), status -> {
                ...
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (languageAvailability == TextToSpeech.LANG_MISSING_DATA || languageAvailability == TextToSpeech.LANG_NOT_SUPPORTED) {
                        Log.w(TAG, "Default locale not available, using English.");
                        locale = Locale.ENGLISH; // Set TextToSpeech language to English
                    }
    ...
    // Set up the FloatingActionButton to speak when clicked
    private void setupButtonToSpeak(Button button) {
        button.setOnClickListener(v -> {
            if (tts != null && !tts.isSpeaking()) {
                String textToSpeak = "Hello, this is a Text to Speech Test!";
